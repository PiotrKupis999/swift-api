...
/*
    @Test
    public void DataServiceTest_UploadDatabaseFromCsvFileLocalPath() {
        List<BankEntity> savedBanks = dataService.uploadDatabaseFromCsvFileLocalPath("P:/Pobrane1/codes.csv");
        Assertions.assertNotNull(savedBanks);
    }
 */
    @Test
    public void DataServiceTest_GetBankEntityBySwiftCode() {
        ...
        BankEntity result = dataService.getBankEntityBySwiftCode("87654321BBB");
    ...
    public void DataServiceTest_FindAllSwiftCodesWithDetailsByCountryISO2() {
        ...
        Country resultZimbabwe = dataService.findAllSwiftCodesWithDetailsByCountryISO2("ZE");
    ...
    public void DataServiceTest_AddBankEntityToDatabase() {
        ...
        ResponseEntity<Map<String, String>> response = dataService.addBankEntityToDatabase(bankEntity);
    ...
    public void DataServiceTest_DeleteBankEntityFromDatabase() {
        ...
        Map<String, String> result = dataService.deleteBankEntityFromDatabase("87654321XXX", "Bank Y", "US");
    ...
    public void DataServiceTest_GetBankEntityBySwiftCode_NotFound() {
        ...
        try {
            dataService.getBankEntityBySwiftCode("11111111XXX");
